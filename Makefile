...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/05/20 11:06:28 by ndlamini          #+#    #+#              #
#    Updated: 2019/06/26 08:28:34 by ndlamini         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES	= ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
		  ...
		  ft_strcmp.c ft_strncmp.c ft_strnew.c ft_strdel.c ft_strdel.c \
		  ft_strclr.c ft_striter.c ft_striteri.c ft_strmap.c ft_strmapi.c \
		  ft_strequ.c ft_strnequ.c ft_strsub.c ft_strjoin.c ft_strtrim.c \
		  ft_strsplit.c ft_itoa.c ft_atoi.c ft_isalpha.c ft_isdigit.c \
		  ft_putchar.c ft_putstr.c ft_putendl.c ft_putnbr.c ft_putchar_fd.c \
		  ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_isalnum.c \
		  ft_isascii.c ft_isprint.c ft_toupper.c ft_tolower.c \

OBJECTS	= ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
		  ft_memchr.o ft_memcmp.o ft_memalloc.o ft_memdel.o ft_strlen.o \
		  ...
		  ft_strjoin.o ft_strtrim.o ft_strsplit.o ft_strlcat.o ft_strchr.o\
		  ft_strrchr.o ft_strstr.o ft_strnstr.o ft_strcmp.o ft_strncmp.o\
		  ft_itoa.o ft_atoi.o ft_isalpha.o ft_isdigit.o ft_isalnum.o ft_isascii.o \
		  ft_isprint.o ft_putchar.o ft_putstr.o ft_putendl.o ft_putnbr.o \ft_putchar_fd.o \
		  ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o ft_toupper.o ft_tolower.o \
